...
class FundingSerializer(serializers.ModelSerializer):
    class Meta:
        model = Funding
        fields = ('id','thumbnail_image', 'place','title', 'description', 'owner_user','backed_list', 'content_image', 'funding_goal_amount', 'funding_amount', 'created_at', 'ended_at','total_likes')
